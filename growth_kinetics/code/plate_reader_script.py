...
def export_tex(growth, date, nice_date, path_to_save, texfilepath, fit_func):
    ...
    for key, value in growth.items():
        ...
        captfig = '. The lines show a fitted logistic model used to determine the growth rate and the doubling time denoted in Table \\ref{tab:' + label + '}.'
        ...
        filefig = path_to_save + label + '.pgf'
    ...
    with open(texfilepath  + date + '_separate.tex', "w") as text_file:
        text_file.write(tex)
